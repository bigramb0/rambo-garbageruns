...
Routes.Locations = {
    ...
    [22] = {
        name = "hawickavenue",
        coords = vector4(-28.21, -96.69, 57.25, 297.7),
    },
    [23] = {
        name = "occupationavenue",
        coords = vector4(-23.66, -235.46, 46.04, 307.41),
    },
    [24] = {
        name = "miltonroad",
        coords = vector4(-579.3, 192.31, 71.48, 25.3),
    },
    [25] = {
        name = "mirrorparkblvd",
        coords = vector4(1180.79, -305.58, 69.02, 358.39),
    },
}